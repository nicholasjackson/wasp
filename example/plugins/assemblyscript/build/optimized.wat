(module
 ...
 (import "plugin" "call_me" (func $assembly/plugins/call_me (param i32) (result i32)))
 (memory $0 1)
 (data (i32.const 1036) ",")
 ...
 (data (i32.const 1548) ",")
 (data (i32.const 1560) "\01\00\00\00\1c\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s")
 (data (i32.const 1596) "\1c")
 (data (i32.const 1608) "\01\00\00\00\0c\00\00\00H\00e\00l\00l\00o\00 ")
 ...
 (data (i32.const 1724) "<")
 (data (i32.const 1736) "\01\00\00\00 \00\00\00~\00l\00i\00b\00/\00d\00a\00t\00a\00v\00i\00e\00w\00.\00t\00s")
 (data (i32.const 1788) "\1c")
 (data (i32.const 1800) "\01\00\00\00\06\00\00\00N\00i\00c")
 (data (i32.const 1820) "<")
 ...
 (data (i32.const 1980) "A\08\00\00\02")
 (data (i32.const 1996) "A\00\00\00\02")
 ...
 (func $assembly/index/hello (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  global.get $~lib/memory/__stack_pointer
